...
def db_2_dat(ifile, ofile, options):
	...
	table_list = [
		...
		['param','MinShareGroupTarget',       '',                    '',             4],
		['param','MinShareGroupWeight',       '',                    '',             3],
		['param','MaxShareGroupTarget',       '',                    '',             4],
		['param','MaxShareGroupWeight',       '',                    '',             3],
		['param','MinInvestShareGroupTarget', '',                    '',             4],
		['param','MinInvestShareGroupWeight', '',                    '',             3],
		['param','MaxInvestShareGroupTarget', '',                    '',             4],
		['param','MaxInvestShareGroupWeight', '',                    '',             3],
		['param','LinkedTechs',               '',                    '',             3],
		['param','SegFrac',                   '',                    '',             2],
		...
		['param','SubsidiesInvest',           '',                    '',             3],
		['param','SubsidiesFixed',            '',                    '',             4],
		['param','SubsidiesVariable',         '',                    '',             4],
