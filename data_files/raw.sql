...
CREATE TABLE "MaxGenGroupTarget" (
	"periods"	integer,
	"group_name"	text,
	"max_act_g"	real,
	"notes"	text,
...
CREATE TABLE "MinShareGroupTarget" (
	"regions"	text,
	"periods"	integer,
	"tech"	text,
	"group_name"	text,
...
CREATE TABLE "MinShareGroupWeight" (
	"regions"	text,
	"tech"	text,
	"group_name"	text,
	"act_fraction"	REAL,
	"tech_desc"	text,
	PRIMARY KEY("regions","tech","group_name")
);

CREATE TABLE "MinInvestShareGroupTarget" (
	"regions"	text,
	"vintage"	integer,
	"tech"	text,
	"group_name"	text,
	"min_share_g"	REAL,
	"tech_desc"	text,
	PRIMARY KEY("regions","vintage","tech","group_name")
);

CREATE TABLE "MaxInvestShareGroupWeight" (
	"regions"	text,
	"tech"	text,
	"group_name"	text,
	"act_fraction"	REAL,
...
CREATE TABLE "MaxInvestShareGroupTarget" (
	"regions"	text,
	"vintage"	integer,
	"tech"	text,
	"group_name"	text,
...
CREATE TABLE "MinInvestShareGroupWeight" (
	"regions"	text,
	"tech"	text,
	"group_name"	text,
	"act_fraction"	REAL,
...
CREATE TABLE "MaxShareGroupTarget" (
	"regions"	text,
	"periods"	integer,
	"tech"	text,
	"group_name"	text,
...
CREATE TABLE "MaxShareGroupWeight" (
	"regions"	text,
	"tech"	text,
	"group_name"	text,
	"act_fraction"	REAL,
...
CREATE TABLE "SubsidiesVariable" (
	"regions"	text NOT NULL,
	"periods"	integer NOT NULL,
	"tech"	text NOT NULL,
	"vintage"	integer NOT NULL,
	"subsidies_variable"	real,
	"subsidies_variable_units"	text,
	"subsidies_variable_notes"	text,
	FOREIGN KEY("tech") REFERENCES "technologies"("tech"),
	FOREIGN KEY("vintage") REFERENCES "time_periods"("t_periods"),
	FOREIGN KEY("periods") REFERENCES "time_periods"("t_periods"),
	PRIMARY KEY("regions","periods","tech","vintage")
...
CREATE TABLE "SubsidiesInvest" (
	"regions"	text,
	"tech"	text,
	"vintage"	integer,
	"subsidies_invest"	real,
	"subsidies_invest_units"	text,
	"subsidies_invest_notes"	text,
	FOREIGN KEY("tech") REFERENCES "technologies"("tech"),
	FOREIGN KEY("vintage") REFERENCES "time_periods"("t_periods"),
	PRIMARY KEY("regions","tech","vintage")
);
...
CREATE TABLE "SubsidiesFixed" (
	"regions"	text NOT NULL,
	"periods"	integer NOT NULL,
	"tech"	text NOT NULL,
	"vintage"	integer NOT NULL,
	"subsidies_fixed"	real,
	"subsidies_fixed_units"	text,
	"subsidies_fixed_notes"	text,
	FOREIGN KEY("tech") REFERENCES "technologies"("tech"),
	FOREIGN KEY("periods") REFERENCES "time_periods"("t_periods"),
	FOREIGN KEY("vintage") REFERENCES "time_periods"("t_periods"),
	PRIMARY KEY("regions","periods","tech","vintage")
